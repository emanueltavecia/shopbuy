...
public class CustomerController {
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "409",
            description = "Cliente com o mesmo CPF ou email já existe",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = ErrorResponse.class))),
  ...
  public ResponseEntity<CustomerDTO> createCustomer(
      @Parameter(description = "Detalhes do cliente para criação", required = true)
          @Valid
          @RequestBody
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "409",
            description = "CPF ou email do cliente conflita com um cliente existente",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = ErrorResponse.class))),
  ...
  public ResponseEntity<CustomerDTO> updateCustomer(
      @Parameter(description = "ID do cliente a ser atualizado", required = true) @PathVariable
          Long id,
      @Parameter(description = "Informações atualizadas do cliente", required = true)
          @Valid
          @RequestBody
          CustomerDTO customerDTO) {
  ...
  @ApiResponses(
      value = {
        ...
        @ApiResponse(
            responseCode = "409",
            description = "Não é possível excluir o cliente porque possui vendas associadas",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = ErrorResponse.class))),
  ...
  public ResponseEntity<SuccessResponse> deleteCustomer(
      @Parameter(description = "ID do cliente a ser excluído", required = true) @PathVariable
          Long id) {
