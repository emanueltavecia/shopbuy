...
public class SaleItemController {
    ...
    @Operation(
        ...
        description = "Retrieves a list of all sale items in the system",
        tags = {"Sale Items"})
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200", 
            description = "Successfully retrieved all sale items",
    ...
    @Operation(
        ...
        description = "Retrieves a specific sale item by its unique identifier",
        tags = {"Sale Items"})
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200", 
            description = "Successfully retrieved the sale item",
            content = @Content(mediaType = "application/json", 
                schema = @Schema(implementation = SaleItemDTO.class))),
        @ApiResponse(
            responseCode = "404", 
    ...
    public ResponseEntity<SaleItemDTO> getSaleItemById(
            @Parameter(description = "ID of the sale item to retrieve", required = true)
            @PathVariable Long id) {
        return ResponseEntity.ok(saleItemService.getSaleItemById(id));
    }

    @Operation(
        summary = "Get items by sale ID",
        description = "Retrieves all items associated with a specific sale",
        tags = {"Sale Items"})
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200", 
            description = "Successfully retrieved sale items",
            content = @Content(mediaType = "application/json", 
                schema = @Schema(implementation = SaleItemDTO.class))),
        @ApiResponse(
            responseCode = "404", 
    ...
    public ResponseEntity<List<SaleItemDTO>> getSaleItemsBySaleId(
            @Parameter(description = "ID of the sale to retrieve items for", required = true)
    ...
    @Operation(
        ...
        description = "Retrieves all sale items that contain a specific product",
        tags = {"Sale Items"})
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200", 
            description = "Successfully retrieved sale items containing the product",
            content = @Content(mediaType = "application/json", 
                schema = @Schema(implementation = SaleItemDTO.class))),
        @ApiResponse(
            responseCode = "404", 
    ...
    public ResponseEntity<List<SaleItemDTO>> getSaleItemsByProductId(
            @Parameter(description = "ID of the product to find in sale items", required = true)
    ...
    public ResponseEntity<SaleItemDTO> createSaleItem(
            @Parameter(description = "Sale item details for creation", required = true)
    ...
    @Operation(
        ...
        description = "Updates an existing sale item's information based on the given ID",
        tags = {"Sale Items"})
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200", 
            description = "Sale item successfully updated",
            content = @Content(mediaType = "application/json", 
                schema = @Schema(implementation = SaleItemDTO.class))),
        @ApiResponse(
            responseCode = "400", 
        ...
        @ApiResponse(
            responseCode = "404", 
            description = "Sale item, sale or product not found",
            content = @Content(mediaType = "application/json", 
                schema = @Schema(implementation = ErrorResponse.class))),
        @ApiResponse(
            responseCode = "500", 
    ...
    public ResponseEntity<SaleItemDTO> updateSaleItem(
            @Parameter(description = "ID of the sale item to update", required = true)
            @PathVariable Long id,
            @Parameter(description = "Updated sale item information", required = true)
            @Valid @RequestBody SaleItemDTO saleItemDTO) {
    ...
    @Operation(
        ...
        description = "Removes a sale item from the system by its ID",
        tags = {"Sale Items"})
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "204", 
            description = "Sale item successfully deleted",
            content = @Content),
        @ApiResponse(
            responseCode = "404", 
            description = "Sale item not found",
    ...
    public ResponseEntity<Void> deleteSaleItem(
            @Parameter(description = "ID of the sale item to delete", required = true)
            @PathVariable Long id) {
