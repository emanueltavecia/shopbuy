...
public class SaleItemController {
  ...
  @Operation(
      summary = "Obter todos os itens de venda",
      description = "Retorna uma lista de todos os itens de venda registrados",
      tags = {"Itens de Venda"})
  @ApiResponses(
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    array =
                        @ArraySchema(schema = @Schema(implementation = DirectSaleItemDTO.class)))),
        @ApiResponse(
            responseCode = "500",
  ...
  @Operation(
      ...
      description = "Retorna um item de venda específico pelo seu ID",
      tags = {"Itens de Venda"})
  @ApiResponses(
      value = {
        @ApiResponse(
            ...
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = DirectSaleItemDTO.class))),
        @ApiResponse(
            responseCode = "404",
  ...
  @Operation(
      summary = "Obter itens por ID da venda",
      description = "Retorna todos os itens associados a uma venda específica",
      tags = {"Itens de Venda"})
  @ApiResponses(
      value = {
        @ApiResponse(
  ...
  public ResponseEntity<List<DirectSaleItemDTO>> getSaleItemsBySaleId(
      @Parameter(description = "ID da venda para retornar itens", required = true) @PathVariable
          Long saleId) {
    return ResponseEntity.ok(saleItemService.getSaleItemsBySaleId(saleId));
  }

  @Operation(
      summary = "Obter itens por ID do produto",
      description = "Retorna todos os itens de venda que contêm um produto específico",
      tags = {"Itens de Venda"})
  @ApiResponses(
      value = {
        @ApiResponse(
  ...
  public ResponseEntity<List<DirectSaleItemDTO>> getSaleItemsByProductId(
      @Parameter(description = "ID do produto para encontrar nos itens de venda", required = true)
          @PathVariable
          Long productId) {
  ...
  @Operation(
      summary = "Criar um novo item de venda",
      description =
          "Cria um novo item de venda. Nota: O campo saleId é obrigatório quando criar o item diretamente por esta API.",
      tags = {"Itens de Venda"})
  @ApiResponses(
      value = {
        @ApiResponse(
  ...
  public ResponseEntity<DirectSaleItemDTO> createSaleItem(
      @Parameter(description = "Detalhes do item de venda para criação", required = true)
          @Validated(ValidationGroups.DirectSaleItemOperation.class)
          @Valid
          @RequestBody
          DirectSaleItemDTO saleItemDTO) {
    return new ResponseEntity<>(saleItemService.createSaleItem(saleItemDTO), HttpStatus.CREATED);
  }

  @Operation(
      summary = "Atualizar um item de venda existente",
      description =
          "Atualiza as informações de um item de venda existente com base no ID fornecido",
      tags = {"Itens de Venda"})
  @ApiResponses(
      value = {
        @ApiResponse(
        ...
        @ApiResponse(
            responseCode = "404",
            description = "Item de venda, venda ou produto não encontrado",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = ErrorResponse.class))),
  ...
  public ResponseEntity<DirectSaleItemDTO> updateSaleItem(
      @Parameter(description = "ID do item de venda a ser atualizado", required = true)
          @PathVariable
          Long id,
      @Parameter(description = "Informações atualizadas do item de venda", required = true)
          @Validated(ValidationGroups.DirectSaleItemOperation.class)
          @Valid
          @RequestBody
          DirectSaleItemDTO saleItemDTO) {
  ...
  @Operation(
      ...
      description = "Remove um item de venda do sistema pelo seu ID",
      tags = {"Itens de Venda"})
  @ApiResponses(
      value = {
        @ApiResponse(
  ...
  public ResponseEntity<SuccessResponse> deleteSaleItem(
      @Parameter(description = "ID do item de venda a ser excluído", required = true) @PathVariable
          Long id) {
