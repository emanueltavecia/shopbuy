        ...
        public OpenAPI customOpenAPI() {
                return new OpenAPI()
                                .info(new Info()
                                                ...
                                                .description("API RESTful para Sistema de Gerenciamento de Loja de Roupas. Esta API fornece endpoints para gerenciar produtos, categorias, marcas, clientes, funcionários, vendas e fornecedores.")
                                                .version("1.0.0"))
                                .externalDocs(new ExternalDocumentation()
                                                .description("Documentação do Sistema de Gerenciamento de Loja de Roupas"))
                                .servers(Arrays.asList(
                                                new Server().url("/").description("URL do Servidor Padrão")))
                                .addTagsItem(new Tag().name("Marcas").description("Operações relacionadas a marcas"))
                                .addTagsItem(new Tag().name("Categorias")
                                                .description("Operações relacionadas a categorias de produtos"))
                                .addTagsItem(new Tag().name("Produtos")
                                                .description("Operações relacionadas a produtos"))
                                .addTagsItem(new Tag().name("Clientes")
                                                .description("Operações relacionadas a clientes"))
                                .addTagsItem(new Tag().name("Funcionários")
                                ...
                                .addTagsItem(new Tag().name("Itens de Venda")
                                                .description("Operações relacionadas a itens de venda"))
                                .addTagsItem(new Tag().name("Fornecedores")
